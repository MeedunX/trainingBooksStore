    ...
    return (
        <div className="flex flex-col justify-between">
            ...
            <div className="flex flex-col">
                ...
                <button className="text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 font-medium  px-5 py-2.5 mt-3 me-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">В корзину</button>
            </div>
        </div>
    )
}
